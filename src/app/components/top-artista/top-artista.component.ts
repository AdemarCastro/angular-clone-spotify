...
export class TopArtistaComponent implements OnInit{
  ...
  topArtista: IArtista = newArtista(); // Eu não posso simplesmente passar NULL para o IArtista pois isso vai acosionar um erro até o Spotify trazer a requisição dos Artistas, por conta disso é mais indicado gerar um Artista vazio até a requisição chegar
